...
const TheDay = () => (
  <section id="theday">
    <h2 style={{ marginBottom: '0.5em' }}>The day</h2>
    <div className="column-group">
      <div className="column-3">
        <img src={pankhurstImg} width={250} height={166} alt="Pankhurst Suite"/>
        <h4 style={{ marginBottom: 0 }}>The Ceremony</h4>
        <p>The day starts of at the Pankhurst Suite in Heron House, Manchester&apos;s registry
          office. The ceremony can sit up to 70 guests so although not everybody has a seat at the
          meal, people are welcome to attend the ceremony if they so wish.</p>
      </div>
      <div className="column-3">
